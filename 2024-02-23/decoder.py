...
class DecoderLayer(nn.Module):
    def __init__(self, hidden_size, filter_size, prob_drop):
        ...
        self.attention = MultiHeadAttention(hidden_size, prob_drop)
...
class Decoder(nn.Module):
    def __init__(self, hidden_size, filter_size, prob_drop, num_layer):
        ...
        decoders = [DecoderLayer(hidden_size, filter_size, prob_drop)
...
if __name__ == "__main__":
    ...
    decoder = Decoder(hidden_size=512, filter_size=2048, prob_drop=0.1, num_layer=6)
