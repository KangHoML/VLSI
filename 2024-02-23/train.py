...
parser.add_argument("--num_layer", type=int, default=256)
...
def get_model(args, src_vocab_size, trg_vocab_size, device):
    if args.model == "Seq2Seq":
        return Seq2Seq(src_vocab_size, trg_vocab_size, args.hidden_size).to(device)
    elif args.model == "Transformer":
        return Transformer(args.hidden_size, args.num_layer, src_vocab_size, trg_vocab_size,
...
def train(args):
    ...
    for epoch in range(args.epoch):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(net.state_dict(), f'./result/{args.model}.pth')
